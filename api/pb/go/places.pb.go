...
func (x *UpdatePlaceSlotRequest) Reset() {
	*x = UpdatePlaceSlotRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_places_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdatePlaceSlotRequest) Descriptor() ([]byte, []int) {
	return file_places_proto_rawDescGZIP(), []int{8}
}
...
var file_places_proto_rawDesc = []byte{
	...
	0x12, 0x10, 0x0a, 0x03, 0x4a, 0x57, 0x54, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x4a,
	0x57, 0x54, 0x22, 0x4e, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6c, 0x61, 0x63,
	0x65, 0x53, 0x6c, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x10, 0x0a, 0x03, 0x4a, 0x57, 0x54, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x4a,
	0x57, 0x54, 0x32, 0x9d, 0x03, 0x0a, 0x08, 0x56, 0x31, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x73, 0x12,
	...
	0x70, 0x74, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x0f, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x53, 0x6c, 0x6f, 0x74, 0x12, 0x1e, 0x2e,
	0x70, 0x6c, 0x61, 0x63, 0x65, 0x73, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6c, 0x61,
	0x63, 0x65, 0x53, 0x6c, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e,
	0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79,
	0x22, 0x00, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x3b, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x6d, 0x61, 0x6e,
...
var file_places_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_places_proto_goTypes = []interface{}{
	...
	(*UpdatePlaceSlotRequest)(nil), // 8: places.UpdatePlaceSlotRequest
	(*Place)(nil),                  // 9: types.Place
	(*EmptyReply)(nil),             // 10: types.EmptyReply
}
var file_places_proto_depIdxs = []int32{
	9,  // 0: places.GetPlaceReply.place:type_name -> types.Place
	9,  // 1: places.FindPlacesReply.places:type_name -> types.Place
	9,  // 2: places.CreatePlaceReply.place:type_name -> types.Place
	...
	8,  // 8: places.V1Places.UpdatePlaceSlot:input_type -> places.UpdatePlaceSlotRequest
	1,  // 9: places.V1Places.GetPlace:output_type -> places.GetPlaceReply
	3,  // 10: places.V1Places.FindPlaces:output_type -> places.FindPlacesReply
	5,  // 11: places.V1Places.CreatePlace:output_type -> places.CreatePlaceReply
	10, // 12: places.V1Places.UpdatePlace:output_type -> types.EmptyReply
	10, // 13: places.V1Places.DestroyPlace:output_type -> types.EmptyReply
	10, // 14: places.V1Places.UpdatePlaceSlot:output_type -> types.EmptyReply
...
func file_places_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_places_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
...
func (c *v1PlacesClient) UpdatePlaceSlot(ctx context.Context, in *UpdatePlaceSlotRequest, opts ...grpc.CallOption) (*EmptyReply, error) {
	out := new(EmptyReply)
	err := c.cc.Invoke(ctx, "/places.V1Places/UpdatePlaceSlot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedV1PlacesServer) UpdatePlaceSlot(context.Context, *UpdatePlaceSlotRequest) (*EmptyReply, error) {
...
func _V1Places_UpdatePlaceSlot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePlaceSlotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(V1PlacesServer).UpdatePlaceSlot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/places.V1Places/UpdatePlaceSlot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(V1PlacesServer).UpdatePlaceSlot(ctx, req.(*UpdatePlaceSlotRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _V1Places_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _V1Places_UpdatePlaceSlot_Handler,
		},
	},
