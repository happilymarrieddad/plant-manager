...
const proto = {};
proto.places = require('./places_pb.js');
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.places.UpdatePlaceRequest,
 *   !proto.types.EmptyReply>}
 */
const methodDescriptor_V1Places_UpdatePlace = new grpc.web.MethodDescriptor(
  '/places.V1Places/UpdatePlace',
  grpc.web.MethodType.UNARY,
  proto.places.UpdatePlaceRequest,
  types_pb.EmptyReply,
  /**
   * @param {!proto.places.UpdatePlaceRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
 ...
 *   !proto.types.EmptyReply>}
 */
const methodInfo_V1Places_UpdatePlace = new grpc.web.AbstractClientBase.MethodInfo(
  types_pb.EmptyReply,
  /**
   * @param {!proto.places.UpdatePlaceRequest} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.places.UpdatePlaceRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 ...
 *     The XHR Node Readable Stream
 */
proto.places.V1PlacesClient.prototype.updatePlace =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/places.V1Places/UpdatePlace',
      request,
      metadata || {},
      methodDescriptor_V1Places_UpdatePlace,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.places.V1PlacesPromiseClient.prototype.updatePlace =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/places.V1Places/UpdatePlace',
      request,
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.places.UpdatePlaceSlotRequest,
 *   !proto.types.EmptyReply>}
 */
const methodDescriptor_V1Places_UpdatePlaceSlot = new grpc.web.MethodDescriptor(
  '/places.V1Places/UpdatePlaceSlot',
  grpc.web.MethodType.UNARY,
  proto.places.UpdatePlaceSlotRequest,
  types_pb.EmptyReply,
  /**
   * @param {!proto.places.UpdatePlaceSlotRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
 ...
 *   !proto.types.EmptyReply>}
 */
const methodInfo_V1Places_UpdatePlaceSlot = new grpc.web.AbstractClientBase.MethodInfo(
  types_pb.EmptyReply,
  /**
   * @param {!proto.places.UpdatePlaceSlotRequest} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.places.UpdatePlaceSlotRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.types.EmptyReply)}
 ...
 *     The XHR Node Readable Stream
 */
proto.places.V1PlacesClient.prototype.updatePlaceSlot =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/places.V1Places/UpdatePlaceSlot',
      request,
      metadata || {},
      methodDescriptor_V1Places_UpdatePlaceSlot,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.places.V1PlacesPromiseClient.prototype.updatePlaceSlot =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/places.V1Places/UpdatePlaceSlot',
      request,
